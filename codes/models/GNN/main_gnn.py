...
def main():
    ...
    parser.add_argument('--checkpoint_interval', type=int, default=0, help='checkpint interval')
    parser.add_argument('--feature', type=str, default='full', help='atom raw features')
    ...
    checkpoint = {'epoch': 0, 'model_state_dict': model.state_dict(), 'optimizer_state_dict': optimizer.state_dict(), 'scheduler_state_dict': scheduler.state_dict(), 'best_val_mae': best_valid_mae, 'num_params': num_params}
    torch.save(checkpoint, os.path.join(args.checkpoint_dir, f'epoch0_checkpoint.pt'))
    ...
    for epoch in range(1, args.epochs + 1):
        ...
        print({'Train': train_mae, 'Validation': valid_mae, "Best_valid": best_valid_mae})
        ...
        if args.checkpoint_interval !=0:
            if epoch % args.checkpoint_interval ==0:
                ...
                torch.save(checkpoint, os.path.join(args.checkpoint_dir, f'epoch{epoch}_checkpoint.pt'))
